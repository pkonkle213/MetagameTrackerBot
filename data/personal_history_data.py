...
def DetermineWhereClause(
    store: Store | None, hub: Hub | None, region: Region | None
) -> str:
    if hub and hub.discord_id == DATAGUILDID:
        ...
        raise KnownError("Unable to determine where clause")


async def GetPairingsHistory(
    user_id: int,
    store: Store | None,
    hub: Hub | None,
    region: Region | None,
